...
$user_lvl  = (!empty($user)) ? $user->lvl() : -1; // wrn guests are allowed 
...
$work_url = 'index.php?mode=skinposer';
$url_params = '';

if ($ratio > 1)
    $url_params .= '&ratio=' . $ratio;
if ($gender != $gender_base)
    $url_params .= '&type=' . $gender;
